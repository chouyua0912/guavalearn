...
public final class Strings {
    ...
    /**
     * Returns a string, of length at least {@code minLength}, consisting of {@code string} prepended       补齐  padding 从开头
    ...
    /**
     * Returns a string, of length at least {@code minLength}, consisting of {@code string} appended        补齐，padding从尾巴
     * with as many copies of {@code padChar} as are necessary to reach that length. For example,
     *
     * <ul>
    ...
    /**
     * Returns a string consisting of a specific number of concatenated copies of an input string. For      重复string
    ...
    /**
     * Returns the given {@code template} string with each occurrence of {@code "%s"} replaced with         匹配String
